...
```shell
log-analyzer --path logs/*.log --format markdown --output report.md --from 2025-03-01
```
...
- распределение запросов по дням недели в процентом соотношении от общего числа **(+доп. баллы)**
...
- Программа должна логировать все важные события, которые происходят во время ее работы.
  ...
  - Для логирования необходимо использовать `slog`.
...
Общее кол-во баллов за работу = 120 б. + 25 доп. б. = **145 б.**

Дополнительные баллы:

- Реализация вывода статистики в формате `ADOC` - 10 б.
- Сбор статистики распределения запрсов по дням недели - 10 б.
