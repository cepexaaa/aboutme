...
// GetEventsBySensorID mocks base method.
func (m *MockEventRepository) GetEventsBySensorID(ctx context.Context, sensorID int64) ([]*domain.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEventsBySensorID", ctx, sensorID)
	ret0, _ := ret[0].([]*domain.Event)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEventsBySensorID indicates an expected call of GetEventsBySensorID.
func (mr *MockEventRepositoryMockRecorder) GetEventsBySensorID(ctx, sensorID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEventsBySensorID", reflect.TypeOf((*MockEventRepository)(nil).GetEventsBySensorID), ctx, sensorID)
}

// GetEventsInTimeRange mocks base method.
func (m *MockEventRepository) GetEventsInTimeRange(ctx context.Context, sensorID int64, start, end time.Time) ([]domain.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEventsInTimeRange", ctx, sensorID, start, end)
	ret0, _ := ret[0].([]domain.Event)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEventsInTimeRange indicates an expected call of GetEventsInTimeRange.
func (mr *MockEventRepositoryMockRecorder) GetEventsInTimeRange(ctx, sensorID, start, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEventsInTimeRange", reflect.TypeOf((*MockEventRepository)(nil).GetEventsInTimeRange), ctx, sensorID, start, end)
}
