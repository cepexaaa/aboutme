...
//    private final TagRepository tagRepository;
    ...
    public PostController(PostService postService, JwtService jwtService, UserService userService, TagRepository tagRepository) {
...
//        return postService.findByIdWithTags(id);
